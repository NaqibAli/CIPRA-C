      ...
      <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
          ...
          <div class="card-box mb-30">
            <div class="pd-20">
              <h4 class="text-blue h4">Companies Applications</h4>
            </div>
            <div class="pb-20">
              <div
        ...
        <div
          ...
          >
            ...
            <div class="modal-header">
              <h5>Approve Company</h5>
            </div>
                <div class="modal-body font-18">
<form id="aproveform">
<span id="cid"  class="d-none"></span>
    <div class="row">
                  <div class="col-4">
                  ...
                  <input type="text" name="expiredate" class="form-control date-picker"  require/>
                  </div>
                  </div>
                </div>
                <button

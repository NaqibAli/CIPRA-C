        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div id="copyrightList" class="table-responsive">
                        <table class="data-table table stripe hover nowrap">
                            ...
                            <tbody id="copyright-tbl">

                            </tbody>
                        </table>
                        <div class="modal fade" id="cregisterModal" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control selectpicker" name="comp_form"
                                                                id="comp_form">
                                                    ...
                                                    <div class="col-md-4 d-none" id="mc-parent">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control selectpicker companies"
                                                                name="mycompanies">
                                                ...
                                                <div id="company-info" class="d-none">
                                                    <section>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Upload Files(Notary,Company Profile,Company
                                                                        Policy)
                                                                        :</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="submitcopyright" class="btn btn-primary"><i
                                                class="dw dw-check"></i> Submit Application</button>
                                    </div>
                                </div>
                            </div>
                        </div>
